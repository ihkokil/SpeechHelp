  ...
  return <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-center">
          <AvatarUpload currentAvatarUrl={profile?.avatar_url} onAvatarChange={handleAvatarChange} size="lg" initials={getUserInitials()} />
        </div>
      </div>
      ...
      <div className="space-y-6 border-t pt-6">
        ...
        <PhoneInput form={form} phoneFieldName="phone" countryFieldName="countryCode" label="Phone Number" placeholder="Enter your phone number" />
      </div>
