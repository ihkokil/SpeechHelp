  ...
  return (
    ...
    >
      <div className="flex items-center mb-4">
        <img src={avatar} alt={`${authorKey} avatar`} className="w-12 h-12 rounded-full mr-4 object-cover border-2 border-pink-100" />
        <div>
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mx-auto text-center mb-12" ref={sectionRef}>
          <h2 className={`text-3xl md:text-4xl font-bold mb-6 opacity-0 ${isVisible ? 'animate-fade-in' : ''}`}>
            <Translate text="testimonials.title" /> <span className="text-pink-600">About Us</span>
          </h2>
        </div>
