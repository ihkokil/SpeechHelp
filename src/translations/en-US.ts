export const enUS = {
  ...
  'features.introText1': 'Ever stared at a blank page and felt it judging you? Whether you\'re giving a wedding toast, rallying a team, or delivering a conference keynote, Speech Help is here to rescue you from idea paralysis and blank-page syndrome.',
  'features.introText2': 'Our step-by-step conversational style wizard will effortlessly guide you through a series of simple and thoughtful questions that unlock your unique perspective and voice. No writing expertise needed - just answer naturally as if chatting with a friend, and we\'ll help shape those responses into a polished speech that sounds exactly like you, only better.',
  ...
  // Headers
  'headers.needCreativeSpeech': 'Need a creative speech?',
  'headers.weCanHelp': 'We can help!',
  'headers.welcomeTo': 'Welcome to',
  'headers.whoWeAre': 'Who We Are &',
  'headers.howWeHelp': 'How We Help',
  'headers.howItWorks': 'How It',
  'headers.works': 'Works',
  'headers.whatClientsAboutUs': 'What our Clients say About Us',
  'headers.readyTransform': 'Ready to Transform Your Public Speaking?',
